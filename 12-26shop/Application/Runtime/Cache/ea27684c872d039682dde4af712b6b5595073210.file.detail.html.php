<?php /* Smarty version Smarty-3.1.6, created on 2017-01-11 21:38:52
         compiled from "./Application/Home/View\Goods\detail.html" */ ?>
<?php /*%%SmartyHeaderCode:17939586a3c21616ab7-14093309%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea27684c872d039682dde4af712b6b5595073210' => 
    array (
  ...
  'nocache_hash' => '17939586a3c21616ab7-14093309',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_586a3c21a644b',
  'variables' => 
  array (
    'info' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_586a3c21a644b')) {function content_586a3c21a644b($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<!--        <script type="text/javascript">
            ...
            var  content=   $('.inputBor').val();
             var  id=   $('#is').val();
//        var   content=document.getElementsByClassName('inputBor');
//   alert(content.value);
               alert(id);
           var  rep=new XMLHttpRequest();
           rep.open("post",'comment',true);
     ...
     var str="em="+email+"&som="+content+"&id"+id;
   ...
   rep.send(str);
    ...
    <body style="cursor: auto;">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top">
                <img class="logo" src="__PUBLIC__/Qimg/logo.gif" />
            </a>
...
?>
        <div class="block box">
            <div class="blank"></div>
            <div id="ur_here">
                当前位置: <a href="#">首页</a> <code>&gt;</code> <a href="#">手机类型</a> <code>&gt;</code> <a href="#">GSM手机</a> <code>&gt;</code> <?php echo $_smarty_tpl->tpl_vars['v']->value['goods_name'];?>
...
9_G_1241511871574.jpg" alt="诺基亚E66" height="310px" width="310px;" />
                            <div class="MagicZoomBigImageCont" style="width: 200px; height: 269px; overflow: hidden; z-index: 100; visibility: visible; position: absolute; top: -10000px; left: 327px; display: block;" id="bc806035">
                                <div style="position: relative; z-index: 10; left: 0px; top: 0px; padding: 3px;" id="MagicZoomHeaderbc806035" class="MagicZoomHeader"><?php echo $_smarty_tpl->tpl_vars['v']->value['goods_name'];?>
                    ...
                    <div class="textInfo">
                        <form action="javascript:addToCart(9)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>上架时间：</strong><?php echo $_smarty_tpl->tpl_vars['v']->value['goods_create_time'];?>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>市场价格：</strong><font class="market">￥<?php echo $_smarty_tpl->tpl_vars['v']->value['goods_price'];?>
元</font><br />
...
stars5.gif" alt="comment rank 5">
                                ...
                                <li class="padd">
                                    <a href="../Index/login?id=1"><img src="/12-26shop/Public/Qimg/goumai2.gif"></a>
                                    <a href="#"><img src="/12-26shop/Public/Qimg/shoucang2.gif"></a>
                                    <a href="#"><img src="/12-26shop/Public/Qimg/tuijian.gif"></a>
                                </li>
                            </ul>
                        </form>
                    </div>
                        ...
                        <div class="box_1">
                            ...
                            <div class="boxCenterList clearfix" style="height: 1%;">
                                ...
                                <div class="commentsList">
                                    <form action="comment?id=<?php echo $_smarty_tpl->tpl_vars['v']->value['goods_id'];?>
...
stars5.gif" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="content" class="inputBor" style="height: 50px; width: 620px;"></textarea>
                                                        <input name="cmt_type" value="0" type="hidden" />
                                                        <input name="id123" id="is" value="" type="hidden" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
